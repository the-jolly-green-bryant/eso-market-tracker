...
export const getItemPathFromId = (id: number | string) =>
  `${ROOT_DIRECTORY}/items/${getShardFromId(id)}/${id}.json`;

export const getItemPath = (item: Item) => getItemPathFromId(item.id);
