    ...
    <div className="tsc-alternative">
      ...
      <main>
        ...
        <div className="tsc-alternative-actions">
          <Link to={routes.getDashboard(platform)}>
            Open the ESO price checker
          </Link>
        ...
        <section>
          ...
          <p>
            Tamriel Savings Co is commonly called TSC, and SavageTSC is
            associated with that community project. ESO Market Tracker is not
            Tamriel Savings Co and does not claim affiliation. This page helps
            players who searched for those names understand that another public
            console market tracker is available.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="tsc-alternative-items">
            {["Dreugh Wax", "Kuta", "Perfect Roe", "Tempering Alloy"].map(
              (item) => (
                <Link key={item} to={routes.getItem(item, platform)}>
                  {item} price
                </Link>
              ),
            )}
