...
const TERMS = (
  <div className="static-content">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to ESO Market
      Tracker.
    </p>
    <p>
      ESO Market Tracker is committed to ensuring that the app is as useful and
    ...
    <p>
      The ESO Market Tracker app stores and processes personal data that you
      have provided to us, to provide my Service. It’s your responsibility to
      keep your phone and access to the app secure. We therefore recommend that
      ...
      features and it could mean that the ESO Market Tracker app won’t work
      properly or at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that ESO Market Tracker
      ...
      be Wi-Fi or provided by your mobile network provider, but ESO Market
      Tracker cannot take responsibility for the app not working at full
    ...
    <p>
      Along the same lines, ESO Market Tracker cannot always take responsibility
      ...
      avail the Service, ESO Market Tracker cannot accept responsibility.
    </p>
    <p>
      With respect to ESO Market Tracker’s responsibility for your use of the
      ...
      can make it available to you. ESO Market Tracker accepts no liability for
    ...
    <p>
      ...
      keep using the app. ESO Market Tracker does not promise that it will
      always update the app so that it is relevant to you and/or works with the
      ...
      you, We may also wish to stop providing the app, and may terminate use of
      it at any time without giving notice of termination to you. Unless we tell
    ...
    <p>These terms and conditions are effective as of 2023-07-22</p>
    <p>
