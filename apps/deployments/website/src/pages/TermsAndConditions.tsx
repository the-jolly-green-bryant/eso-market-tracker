...
const TermsAndConditions: React.FC = () => {
    return (
        <PageContainer pageTitle="Terms and Conditions">
            <div className="static-content">
                ...
                <p>
                    ESO Market Tracker is committed to ensuring that the app is
                ...
                <p>
                    The ESO Market Tracker app stores and processes personal
                    data that you have provided to us, to provide my Service.
                    ...
                    that the ESO Market Tracker app won’t work properly or at
                    all.
                </p>
                <div>
                    <p>
                ...
                <p>
                    You should be aware that there are certain things that ESO
                    Market Tracker will not take responsibility for. Certain
                    functions of the app will require the app to have an active
                    internet connection. The connection can be Wi-Fi or provided
                    by your mobile network provider, but ESO Market Tracker
                ...
                <p>
                    Along the same lines, ESO Market Tracker cannot always take
                    responsibility for the way you use the app i.e. You need to
                    make sure that your device stays charged – if it runs out of
                    battery and you can’t turn it on to avail the Service, ESO
                    Market Tracker cannot accept responsibility.
                </p>
                <p>
                    With respect to ESO Market Tracker’s responsibility for your
                    ...
                    available to you. ESO Market Tracker accepts no liability
                ...
                <p>
                    ...
                    using the app. ESO Market Tracker does not promise that it
